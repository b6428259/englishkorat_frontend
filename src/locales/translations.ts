...
export interface Translations {
  ...
  // Messages
  submitBorrowRequest: string;
  borrowRequestSent: string;
  ...
  noBorrowsFound: string;
  exceedRenewalLimit: string;
...
export const translations: Record<Language, Translations> = {
  th: {
    ...
    heroDescription:
      "ที่เรียนที่ดีที่สุด สำหรับคนที่ #อ่อนภาษาอังกฤษ เปลี่ยนชีวิตหลังเรียน ใน 3 เดือน ‼️",
    ...
    readyToChangeDesc:
      "เข้าร่วมกับนักเรียนกว่า 24,000+ คนที่ประสบความสำเร็จกับเรา เรียนออนไลน์หรือที่สาขาก็ได้ เลือกตามความสะดวกของคุณ",
    ...
    coursesDescription:
      "เลือกคอร์สที่เหมาะกับระดับและความต้องการของคุณ พร้อมวิธีการสอนที่เป็นเอกลักษณ์",
    courseFeatures: "คุณสมบัติของคอร์ส",
    basicCourse: "คอร์สพื้นฐาน (Basic)",
    basicCourseDesc:
      "เหมาะสำหรับผู้เริ่มต้นเรียนภาษาอังกฤษ เน้นพื้นฐานการสื่อสาร",
    intermediateCourse: "คอร์สปานกลาง (Intermediate)",
    intermediateCourseDesc:
      "สำหรับผู้ที่มีพื้นฐานแล้ว ต้องการพัฒนาทักษะให้สูงขึ้น",
    advancedCourse: "คอร์สสูง (Advanced)",
    advancedCourseDesc:
      "เน้นการใช้ภาษาระดับสูง เพื่อการทำงานและการสื่อสารที่ซับซ้อน",
    ...
    aboutDescription:
      "English Korat เป็นสถาบันสอนภาษาอังกฤษที่มุ่งมั่นพัฒนาการศึกษาภาษาอังกฤษให้กับคนไทย",
    ourMission: "ภารกิจของเรา",
    ourMissionDesc:
      "เราต้องการทำให้คนไทยทุกคนสามารถพูดภาษาอังกฤษได้อย่างมั่นใจ ด้วยวิธีการสอนที่เข้าใจปัญหาของคนไทย",
    ourVision: "วิสัยทัศน์",
    ourVisionDesc:
      "เป็นสถาบันสอนภาษาอังกฤษอันดับหนึ่งในภาคตะวันออกเฉียงเหนือ ที่ให้ผลลัพธ์ที่เห็นได้จริง",
    ourTeam: "ทีมงานของเรา",
    ourTeamDesc:
      "ทีมผู้สอนที่มีประสบการณ์และใจรักในการสอน พร้อมให้คำปรึกษาในทุกขั้นตอนการเรียนรู้",
    ourMethod: "วิธีการสอนของเรา",
    ourMethodDesc:
      "เราใช้วิธีการสอนที่เน้นการฝึกฝนและการใช้งานจริง ไม่เน้นท่องจำ แต่เน้นความเข้าใจและการประยุกต์ใช้",
    whyTrustUs: "ทำไมควรเชื่อใจเรา",
    experiencedTeachers: "ครูผู้สอนมากประสบการณ์",
    experiencedTeachersDesc:
      "ทีมครูที่มีประสบการณ์การสอนมากกว่า 10 ปี และเข้าใจปัญหาของคนไทย",
    provenMethod: "วิธีการที่พิสูจน์แล้ว",
    provenMethodDesc:
      "มีผลงานการสอนที่เป็นที่ยอมรับ กับนักเรียนกว่า 24,000+ คน",
    comprehensiveSupport: "การสนับสนุนที่ครอบคลุม",
    comprehensiveSupportDesc:
      "ติดตามผลการเรียนและให้คำปรึกษาตลอดระยะเวลาการเรียน",
    ...
    informationCollectionDesc:
      "เราเก็บรวบรวมข้อมูลที่จำเป็นสำหรับการให้บริการการศึกษาเท่านั้น",
    informationUse: "การใช้ข้อมูล",
    informationUseDesc:
      "ข้อมูลของคุณจะถูกใช้เพื่อการจัดการการเรียนการสอนและการติดต่อสื่อสาร",
    ...
    thirdPartyServicesDesc:
      "เราอาจใช้บริการของบุคคลที่สามในการให้บริการบางส่วน",
    ...
    userResponsibilitiesDesc:
      "ผู้ใช้ต้องใช้บริการอย่างถูกต้องและไม่ละเมิดสิทธิของผู้อื่น",
    ...
    intellectualPropertyDesc:
      "เนื้อหาการสอนและสื่อการเรียนเป็นลิขสิทธิ์ของสถาบัน",
    ...
    terminationDesc:
      "สถาบันสงวนสิทธิในการยุติบริการในกรณีที่มีการละเมิดข้อกำหนด",

    // Dashboard
    welcomeMessage: "ยินดีต้อนรับ!",
    welcomeSubMessage:
      "คุณได้เข้าสู่ระบบเรียบร้อยแล้ว เริ่มต้นการเรียนรู้ภาษาอังกฤษกับเรา",
    ...
    bulkCreateDescription:
      "ฟีเจอร์นี้จะช่วยให้คุณสร้างตารางเรียนจำนวนมากได้อย่างง่ayดาย",
    ...
    publishedYear: "ปีที่พิมพ์",
    description: "คำอธิบาย",
    totalStock: "จำนวนทั้งหมด",
    availableStock: "จำนวนที่พร้อมให้ยืม",
    maxBorrowDays: "ยืมได้สูงสุด (วัน)",
    renewableCount: "ต่ออายุได้ (ครั้ง)",
    lateFeePerDay: "ค่าปรับ/วัน (บาท)",
    requiresApproval: "ต้องการการอนุมัติ",
    unlimited: "ไม่จำกัด",
    noLateFee: "ไม่มีค่าปรับ",

    // Borrow Request
    quantityItem: "จำนวน",
    pickupDate: "วันที่รับ",
    returnDate: "วันที่คืน",
    requestNotes: "หมายเหตุ",
    reviewNotes: "หมายเหตุการตรวจสอบ",
    returnNotes: "หมายเหตุการคืน",

    // Messages
    submitBorrowRequest: "ส่งคำขอยืม",
    borrowRequestSent: "ส่งคำขอยืมเรียบร้อยแล้ว",
    waitingForApproval: "รอการอนุมัติจากแอดมิน",
    requestApproved: "อนุมัติคำขอยืมสำเร็จ",
    requestRejected: "ปฏิเสธคำขอยืมสำเร็จ",
    requestCancelled: "ยกเลิกคำขอยืมเรียบร้อยแล้ว",
    renewSuccess: "ต่ออายุการยืมเรียบร้อยแล้ว",
    checkInSuccess: "รับคืนสำเร็จ",
    itemCreated: "เพิ่มรายการสำเร็จ",
    itemUpdated: "อัพเดทรายการสำเร็จ",
    itemDeleted: "ลบรายการสำเร็จ",

    // Errors
    errorOccurred: "เกิดข้อผิดพลาด",
    noItemsFound: "ไม่พบรายการ",
    noRequestsFound: "ยังไม่มีคำขอยืม",
    noBorrowsFound: "ยังไม่มีรายการยืม",
    exceedRenewalLimit: "เกินจำนวนครั้งที่ต่ออายุได้",
    confirmDelete: "ต้องการลบรายการนี้ใช่หรือไม่?",
    confirmCancel: "ต้องการยกเลิกคำขอยืมนี้ใช่หรือไม่?",
    reasonRequired: "กรุณาระบุเหตุผล",

    // Details
    itemDetails: "รายละเอียดสิ่งของ",
    requestDetails: "รายละเอียดคำขอ",
    transactionDetails: "รายละเอียดการยืม",
    borrowedBy: "ยืมโดย",
    requestedBy: "ขอโดย",
    ...
    conditionOnBorrow: "สภาพตอนยืม",
    conditionOnReturn: "สภาพตอนคืน",
    lateFee: "ค่าปรับล่าช้า",
    damageFee: "ค่าเสียหาย",
    totalFee: "ค่าธรรมเนียมทั้งหมด",
    renewalCount: "จำนวนครั้งที่ต่อแล้ว",
    stockInfo: "คงเหลือ {available}/{total}",

    // Dashboard
    totalItems: "รายการทั้งหมด",
    currentlyBorrowed: "กำลังยืม",
    overdueItems: "เกินกำหนด",
    pendingApprovals: "รอการอนุมัติ",
    inventoryStatus: "สถานะคลัง",
    thisMonth: "เดือนนี้",
    borrowedThisMonth: "ยืม",
    returnedThisMonth: "คืน",
    outstandingFees: "ค่าปรับค้างชำระ",
    viewManagement: "ดูการจัดการ",
    ...
    // Footer
    footerDescription:
      "เราทำให้คุณพูดได้ - สถาบันสอนภาษาอังกฤษที่ดีที่สุดในโคราช พร้อมเปลี่ยนชีวิตคุณใน 3 เดือน",
    mainMenu: "เมนูหลัก",
    ...
    coursesPageSubtitle:
      "เลือกคอร์สที่เหมาะกับคุณ เรียนกับเราแล้วพูดได้จริงใน 3 เดือน",
    ...
    whyOurCoursesDesc:
      "เราใส่ใจทุกรายละเอียด เพื่อให้คุณได้รับการเรียนรู้ที่ดีที่สุด",
    readyToStartLearning: "พร้อมเริ่มเรียนแล้วหรือยัง?",
    readyToStartLearningDesc:
      "เข้าร่วมกับเราวันนี้ และเริ่มต้นการเปลี่ยนแปลงชีวิตของคุณ",
    contactForInfo: "ติดต่อสอบถาม",

    // About Page
    aboutPageTitle: "เกี่ยวกับเรา",
    aboutPageSubtitle:
      "English Korat - สถาบันสอนภาษาอังกฤษที่ทำให้คุณพูดได้จริง",
    contactUs: "ติดต่อเรา",
    missionStatement:
      "เราตั้งใจจะทำให้ทุกคนพูดภาษาอังกฤษได้อย่างมั่นใจ ใน 3 เดือน",
    ourStory: "เรื่องราวของเรา",
    storyParagraph1:
      "English Korat เริ่มต้นขึ้นในปี 2019 ด้วยความตั้งใจที่จะแก้ไขปัญหาของคนไทยที่เรียนภาษาอังกฤษมานานแต่ยังพูดไม่ได้ เราเห็นว่าปัญหานี้เกิดจากวิธีการสอนที่เน้นไวยากรณ์มากเกินไป แต่ขาดการฝึกฝนการสนทนาจริง",
    storyParagraph2:
      "ด้วยประสบการณ์ในการสอนมากกว่า 10 ปี เราได้พัฒนาวิธีการสอนที่เน้นการใช้งานจริง ทำให้นักเรียนสามารถพูดได้อย่างมั่นใจในเวลาเพียง 3 เดือน วิธีการนี้ได้รับการพิสูจน์แล้วจากนักเรียนกว่า 1,000 คนที่ประสบความสำเร็จ",
    storyParagraph3:
      "วันนี้ English Korat ได้กลายเป็นสถาบันชั้นนำในจังหวัดนครราชสีมา ด้วยผู้ติดตามมากกว่า 24,000 คน เราภูมิใจที่ได้เป็นส่วนหนึ่งในการเปลี่ยนแปลงชีวิตของผู้คน ทำให้พวกเขามีโอกาสที่ดีขึ้นในการทำงานและชีวิต",
    ourValues: "ค่านิยมของเรา",
    valuesDescription:
      "ค่านิยมที่ขับเคลื่อนเราในการสร้างการเรียนรู้ที่มีคุณภาพ",
    qualityEducation: "การศึกษาคุณภาพ",
    qualityEducationDesc:
      "เราใส่ใจในทุกรายละเอียดของการสอน เพื่อให้นักเรียนได้รับความรู้ที่มีคุณภาพสูงสุด",
    innovation: "นวัตกรรม",
    innovationDesc:
      "เราพัฒนาวิธีการสอนใหม่ ๆ อยู่เสมอ เพื่อให้การเรียนรู้เป็นเรื่องที่สนุกและมีประสิทธิภาพ",
    studentCare: "ใส่ใจนักเรียน",
    studentCareDesc:
      "เราให้ความสำคัญกับทุกคน ดูแลและสนับสนุนให้นักเรียนทุกคนประสบความสำเร็จ",
    results: "ผลลัพธ์",
    resultsDesc:
      "เราให้ความสำคัญกับผลลัพธ์ที่เกิดขึ้นจริง มุ่งมั่นที่จะทำให้นักเรียนพูดได้จริงใน 3 เดือน",
    community: "ชุมชน",
    communityDesc:
      "เราสร้างชุมชนการเรียนรู้ที่อบอุ่น ทุกคนช่วยเหลือและสนับสนุนซึ่งกันและกัน",
    excellence: "ความเป็นเลิศ",
    excellenceDesc:
      "เราไม่หยุดที่จะพัฒนาและปรับปรุง เพื่อให้บริการที่เป็นเลิศแก่นักเรียนทุกคน",
    meetOurTeam: "ทีมงานของเรา",
    teamDescription:
      "ทีมงานมืออาชีพที่มีประสบการณ์และทุ่มเทเพื่อความสำเร็จของนักเรียน",
    ourAchievements: "ความสำเร็จของเรา",
    achievementsDescription:
      "ผลงานที่เราภูมิใจและเป็นแรงผลักดันให้เราก้าวต่อไป",
    readyToJoin: "พร้อมเข้าร่วมกับเรา?",
    readyToJoinDescription:
      "เริ่มต้นเปลี่ยนแปลงชีวิตของคุณวันนี้ เรียนกับเราและพูดภาษาอังกฤษได้ใน 3 เดือน",
    ...
    readyToTalkDesc:
      "ติดต่อเราเพื่อเริ่มต้นเปลี่ยนแปลงชีวิตของคุณไปกับภาষาอังกฤษ",
  ...
  en: {
    ...
    heroDescription:
      "The best place to learn for those who are #weak in English. Transform your life after studying in just 3 months ‼️",
    startLearning: "Start Learning Today",
    whyChooseUs: "Why Choose English Korat?",
    whyChooseDesc:
      "We have unique teaching methods that will help you speak English confidently",
    changeLifeIn3Months: "Transform Your Life in 3 Months",
    changeLifeDesc:
      "Proven teaching methods that can help you speak English in a short time",
    perfectForBeginners: "Perfect for Beginners",
    perfectForBeginnersDesc:
      "We understand Thai people's English learning challenges and have targeted solutions",
    ...
    readyToChangeDesc:
      "Join over 24,000+ students who have succeeded with us. Learn online or at our branch - choose what's convenient for you",
    joinUs: "Join Us",
    ...
    coursesDescription:
      "Choose the course that fits your level and needs with our unique teaching methods",
    courseFeatures: "Course Features",
    basicCourse: "Basic Course",
    basicCourseDesc:
      "Perfect for English beginners, focusing on basic communication skills",
    intermediateCourse: "Intermediate Course",
    intermediateCourseDesc:
      "For those with basic knowledge who want to advance their skills",
    advancedCourse: "Advanced Course",
    advancedCourseDesc:
      "Focus on high-level language use for work and complex communication",
    ...
    aboutTitle: "About Us",
    aboutDescription:
      "English Korat is an English language institute dedicated to developing English education for Thai people",
    ourMission: "Our Mission",
    ourMissionDesc:
      "We want every Thai person to be able to speak English confidently with teaching methods that understand Thai people's problems",
    ourVision: "Our Vision",
    ourVisionDesc:
      "To be the number one English language institute in Northeast Thailand that delivers real, visible results",
    ourTeam: "Our Team",
    ourTeamDesc:
      "Experienced teachers with passion for teaching, ready to provide guidance at every step of learning",
    ourMethod: "Our Teaching Method",
    ourMethodDesc:
      "We use teaching methods that focus on practice and real-world application, not memorization, but understanding and practical application",
    whyTrustUs: "Why Trust Us",
    experiencedTeachers: "Experienced Teachers",
    experiencedTeachersDesc:
      "Teaching team with over 10 years of experience who understand Thai people's challenges",
    ...
    comprehensiveSupportDesc:
      "Monitor learning progress and provide guidance throughout the learning period",

    // Contact Page
    contactTitle: "Contact Us",
    contactDescription:
      "Ready to provide consultation and answer questions about English learning",
    ...
    informationCollectionDesc:
      "We only collect information necessary for providing educational services",
    informationUse: "Information Use",
    informationUseDesc:
      "Your information will be used for educational management and communication",
    ...
    thirdPartyServicesDesc:
      "We may use third-party services in providing some services",
    ...
    userResponsibilitiesDesc:
      "Users must use services properly and not violate others' rights",
    paymentTerms: "Payment Terms",
    paymentTermsDesc:
      "Tuition payments must be made according to specified terms",
    cancellationPolicy: "Cancellation Policy",
    cancellationPolicyDesc:
      "Course cancellations must be notified in advance according to specified terms",
    intellectualProperty: "Intellectual Property",
    intellectualPropertyDesc:
      "Teaching content and learning materials are copyrighted by the institute",
    limitationLiability: "Limitation of Liability",
    limitationLiabilityDesc:
      "The institute limits liability according to legal framework",
    termination: "Service Termination",
    terminationDesc:
      "The institute reserves the right to terminate services in case of terms violation",

    // Dashboard
    welcomeMessage: "Welcome!",
    welcomeSubMessage:
      "You have successfully logged in. Start your English learning journey with us",
    ...
    bulkCreateDescription:
      "This feature will help you create multiple schedules easily",
    ...
    renewableCount: "Renewable Count",
    lateFeePerDay: "Late Fee Per Day",
    requiresApproval: "Requires Approval",
    unlimited: "Unlimited",
    noLateFee: "No Late Fee",
    ...
    // Messages
    submitBorrowRequest: "Submit Borrow Request",
    ...
    noBorrowsFound: "No borrows found",
    exceedRenewalLimit: "Exceeded renewal limit",
    ...
    onlineOrBranch:
      "Study online or at our branch, choose what's convenient for you",
    ...
    // Footer
    footerDescription:
      "We make you speak - The best English institute in Korat, ready to transform your life in 3 months",
    mainMenu: "Main Menu",
    ...
    coursesPageSubtitle:
      "Choose the course that's right for you. Learn with us and speak fluently in 3 months",
    ...
    whyOurCoursesDesc:
      "We pay attention to every detail to give you the best learning experience",
    ...
    aboutPageSubtitle:
      "English Korat - The institute that makes you really speak English",
    contactUs: "Contact Us",
    missionStatement:
      "We are committed to making everyone speak English confidently in 3 months",
    ourStory: "Our Story",
    storyParagraph1:
      "English Korat began in 2019 with the intention to solve the problem of Thai people who have studied English for a long time but still can't speak. We saw that this problem arose from teaching methods that focused too much on grammar but lacked real conversation practice.",
    storyParagraph2:
      "With more than 10 years of teaching experience, we have developed a practical teaching method that enables students to speak confidently in just 3 months. This method has been proven by more than 1,000 students who have succeeded.",
    storyParagraph3:
      "Today, English Korat has become a leading institute in Nakhon Ratchasima province with more than 24,000 followers. We are proud to be part of transforming people's lives, giving them better opportunities in work and life.",
    ourValues: "Our Values",
    valuesDescription: "The values that drive us to create quality learning",
    qualityEducation: "Quality Education",
    qualityEducationDesc:
      "We care about every detail of teaching to provide students with the highest quality knowledge",
    innovation: "Innovation",
    innovationDesc:
      "We constantly develop new teaching methods to make learning fun and effective",
    studentCare: "Student Care",
    studentCareDesc:
      "We value everyone, care for and support every student to succeed",
    results: "Results",
    resultsDesc:
      "We focus on real results, committed to making students speak fluently in 3 months",
    community: "Community",
    communityDesc:
      "We create a warm learning community where everyone helps and supports each other",
    excellence: "Excellence",
    excellenceDesc:
      "We never stop developing and improving to provide excellent service to all students",
    meetOurTeam: "Meet Our Team",
    teamDescription:
      "Professional team with experience and dedication to student success",
    ourAchievements: "Our Achievements",
    achievementsDescription:
      "The achievements we are proud of and that drive us forward",
    readyToJoin: "Ready to Join Us?",
    readyToJoinDescription:
      "Start transforming your life today. Learn with us and speak English in 3 months",
    startToday: "Start Today",

    // Contact Page
    contactPageTitle: "Contact Us",
    contactPageSubtitle:
      "Ready to provide consultation and answer all your questions. Contact us through any channel",
    registerNow: "Register Now",
    callNow: "Call Now",
    contactMethods: "Contact Methods",
    contactMethodsDesc:
      "Choose the channel that's convenient for you. We're available every day",
    ...
    privacyPolicyDescription:
      "We value your privacy and protecting your personal information",

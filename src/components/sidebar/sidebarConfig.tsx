...
export const getSidebarItems = (t: Translations): SidebarItem[] => [
  ...
  },
  {
    ...
    children: [
      {
        id: "attendance-teacher-checkin",
        label: "เช็คอิน (อาจารย์)",
        href: "/attendance/teacher/check-in",
        icon: <HiOutlineCheckCircle {...iconProps} />,
      },
      {
        id: "attendance-student-checkin",
        label: "เช็คอิน (นักเรียน)",
        href: "/attendance/student/check-in",
        icon: <HiOutlineCheckCircle {...iconProps} />,
      },
      {

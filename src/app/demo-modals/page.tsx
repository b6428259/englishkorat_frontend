...
const mockCourses = [
  { id: '1', name: 'Basic English', level: 'beginner', duration_hours: 60 },
  { id: '2', name: 'Intermediate English', level: 'intermediate', duration_hours: 80 },
  { id: '3', name: 'Advanced English', level: 'advanced', duration_hours: 100 },
];
